...
const dictionary: Record<Lang, StaffDashboardDict> = {
  en: {
    ...
    mailHelpBody: 'Use Mail to contact your manager privately. Messages and replies remain in this conversation.',
    preferenceModalTitle: "Submit next month's shift preference",
    workStatusHelpAriaLabel: 'About work status',
    workStatusHelpBody: 'Select Clock in when you start work and Clock out when you finish. When clocking out, confirm the break time you actually took. Your manager can review the saved attendance record.',
    scheduleHelpAriaLabel: 'About the shift schedule',
    scheduleHelpBody: 'Shows the shifts currently assigned to you and your coworkers. Select "Only me" to see just your shifts. Open a date in your row to check details or request a change when available.',
    transportHelpAriaLabel: 'About transportation cost',
    transportHelpBody: "Enter today's transportation cost. It saves automatically and appears in today's work report for your manager to review.",
  ...
  ja: {
    ...
    mailHelpBody: 'マネージャーへの個別連絡に使います。送信した内容と返信は、この会話に残ります。',
    preferenceModalTitle: '来月のシフト希望を提出',
    workStatusHelpAriaLabel: '勤務状況について',
    workStatusHelpBody: '仕事を始めるときに「出勤」、終えるときに「退勤」を押してください。退勤時には、実際に取った休憩時間を確認します。保存した勤怠記録はマネージャーが確認できます。',
    scheduleHelpAriaLabel: 'シフト表について',
    scheduleHelpBody: '現在割り当てられている自分と同僚のシフトを確認できます。「自分のみ」にすると、自分の予定だけを表示します。自分の行の日付を開くと、詳細の確認や、利用できる場合は変更申請ができます。',
    transportHelpAriaLabel: '交通費について',
    transportHelpBody: '本日の交通費を入力してください。内容は自動保存され、本日の勤務報告としてマネージャーが確認できます。',
