...
const MANAGER_DICT: Record<Lang, ManagerDict> = {
  ja: {
    ...
    backToHub: 'ホームに戻る',
    removeStaffButton: 'スタッフを無効化',
    confirmRemoveStaffTitle: 'このスタッフを無効化しますか？',
  ...
  en: {
    ...
    removeStaffButton: 'Deactivate staff',
    confirmRemoveStaffTitle: 'Deactivate this staff member?',
    confirmRemoveStaffBody:
